...
<header class="header">
    ...
    <a href="/project-website/home.php" class="logo"> <span>max</span>motors </a>
...
<div class = "card-wrapper">
    <div class = "card">
      ...
      <div class = "product-imgs">
        <div class = "img-display">
          <div class = "img-showcase">
            <img src = "cars/trial1.png" alt = "shoe image">
            <img src = "cars/trail2.webp" alt = "shoe image">
            <img src = "cars/trail3.webp" alt = "shoe image">
            <img src = "cars/trail4.webp" alt = "shoe image">
          </div>
        </div>
        <div class = "img-select">
          <div class = "img-item">
            <a href = "#" data-id = "1">
              <img src = "cars/trail1.webp" alt = "shoe image">
            </a>
          </div>
          <div class = "img-item">
            <a href = "#" data-id = "2">
      ...
      <div class = "product-content">
        <h2 class = "product-title">Chevrolet Trailblazer</h2>
